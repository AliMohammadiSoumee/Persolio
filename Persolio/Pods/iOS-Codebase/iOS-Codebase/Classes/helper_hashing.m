...
{
    return [helper_hashing hmacForKey:_hash_key1 andData:md5];
}
...
+(NSData*)hashDictionary:(NSDictionary *)dic
{
    ...
    NSString* hmac = [helper_hashing hmacForKey:_hash_key1 andData:dicJSON];
...
{
    NSString* hmac = [helper_hashing hmacForKey:_hash_key1 andData:str];
    return hmac;
}
